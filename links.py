...
def se():
  ...
  if day=='Sun' or c[0]=='0':
    ...
    return('Today no class for Software Engineering !')
  else:
    return(temp[2])
def cns():
  day=d()
...
def cdlab():
  ...
  if day=='Sun' or c[0]=='0':
    ...
    temp[7]=const
    return('Today no classes scheduled for Compiler Design LAB !')
def selab():
  day=d()
  time=gettime()
  if day=='Sun' or c[0]=='0':
    ...
    temp[8]=const
    return('Today no classes scheduled for Software Engineering LAB !')
    """
def mplab():
  day=d()
  time=gettime()
